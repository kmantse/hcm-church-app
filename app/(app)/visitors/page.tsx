              ...
              <tbody className="divide-y divide-slate-100">
                {visitors.map((v) => (
                  <tr key={v.id} className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="px-4 py-3 text-slate-500">
                      {v.visits[0] ? formatDate(v.visits[0].visitDate) : formatDate(v.createdAt)}
                    </td>
                    <td className="px-4 py-3">
                      <span className="inline-flex items-center justify-center w-7 h-7 bg-green-100 text-green-700 rounded-full text-xs font-bold">
                        {v.visits.length}
                      </span>
                    </td>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <FormField label="Purpose of Visit">
              <input
                ...
                className={inputClass}
                placeholder="First visit, prayer, etc."
              />
            </FormField>
          </div>
